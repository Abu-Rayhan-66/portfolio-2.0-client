...
const Contact = () => {
  return (
   <Transition>
     <div className="max-w-7xl rounded-3xl  mx-auto p-4 border border-gray-500/[0.300] bg-opacity-80 bg-[#222d44] ">
      <div className="flex flex-col md:flex-row gap-6 bg-gradient-to-b from-gray-900 to-gray-950 rounded-xl p-2">
