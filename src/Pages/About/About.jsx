...
const About = () => {
    return (
        <Transition>
            <div className='mb-10'>
            <div className="flex flex-col lg:flex-row gap-10 mt-10 items-center justify-center px-5 max-w-7xl mx-auto">
